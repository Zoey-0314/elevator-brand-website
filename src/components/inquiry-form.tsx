...
export function InquiryForm({ initialProduct = "", sourcePage }: Props) {
  ...
  const copy = isZh ? {
    ...
    projectMessage: "项目说明",
    messagePlaceholder: "整机询盘请说明建筑、地点、项目阶段与时间计划；零件加工或配件生产请说明零件用途、图纸或技术要求、材质、数量与交付需求。",
    ...
    messagePlaceholder: "For complete elevators, describe the building, location, project stage, and timeline. For parts machining or component production, describe the application, drawing or technical requirements, material, quantity, and delivery needs.",
